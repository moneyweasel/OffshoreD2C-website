    ...
    '<div class="gate-card">',
      ...
      '<div class="gate-screens">',
        ...
        '<div class="gate-screen active" id="gate-screen-1">',
          ...
          '<p class="gate-lead">This website is operated by NG Funds and is directed at investors in the United Kingdom and offshore investors who are permitted to access financial products listed on the London Stock Exchange under the laws of their jurisdiction of residence.</p>',
        ...
        '<div class="gate-screen" id="gate-screen-retail">',
          ...
          '<div class="gate-checks" id="retail-checks">',
            ...
            '<label class="gate-check"><input type="checkbox" data-check="r4"><span>I understand that investing through Interactive Brokers is a <strong>self-directed, execution-only</strong> arrangement. I am responsible for my own investment decisions, account compliance, and adherence to the laws of my jurisdiction of residence.</span></label>',
